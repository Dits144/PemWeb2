...
<body>
    ...
    <div class="container-fluid mt-5" id="kategori">
    ...
    <div class="container-fluid bg-dark py-5">
        <div class="container text-center text">
            <h3>Tentang Kami</h3>
            <p class="fs-5 mt-3"></p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad asperiores aspernatur hic beatae ab molestias
            similique aut inventore repellendus vitae. Est inventore voluptatibus officiis, aliquam ut et molestias sit
            excepturi ab consequuntur aperiam beatae vitae enim nulla iure tenetur fuga nisi facilis? Rem magnam
            incidunt temporibus vero, sed illum iste.
        </div>
    </div>
</body>
                ...
                <div class="col-sm-6 col-md-4 mb-3">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="formpesanan.php?nama=php?nama=<?php echo $data['id']; ?>"
